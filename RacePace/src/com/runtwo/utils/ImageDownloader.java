...
public class ImageDownloader {
	...
	private Mode mode = Mode.NO_ASYNC_TASK; // Mode.CORRECT; //
	 ...
	 */
	public void download(String url, ImageView imageView,Activity travelExpenseActivity) {

		// resetPurgeTimer();
		MyAsycTask asycTask=new MyAsycTask(url,imageView,travelExpenseActivity);
		asycTask.execute();
		
	}
 class  MyAsycTask extends AsyncTask<Void, Void, Bitmap>{
	 String url;
	ImageView imageView;
	Activity context;
	 public MyAsycTask(String url, ImageView imageView,Activity travelExpenseActivity) {
		// TODO Auto-generated constructor stub
	this.url=url;
	this.imageView=imageView;
	this.context=travelExpenseActivity;
	}
	 ...
	 */
	private void forceDownload(String url, final ImageView imageView,Activity context) {
		/*
